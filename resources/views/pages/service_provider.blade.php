...
<section role="main" class="content-body">
	...
	<!-- start: page -->
	<body>
	<div class="container-fluid mybody" align="center"> 
		<h2> User Operation</h2> <hr/>
		<button type="button" class="btn btn-warning" id="add" name="add" data-toggle="collapse" data-target="#add_user">Add Provider</button>
		<br><br>
	<!--############################  Add User ####################################-->
  		<div class="collapse" id="add_user">  <!--Start Collapse -->
			<h3 class="title" align="center"><u>New User</u></h3>
			  <form method="post" id="userform">
				<table class="table mybody"> 
					...
					<tr><div class="form-group">
						    ...
						    <td colspan="2"><textarea class="form-control" name="note" id="note"></textarea></td>
						</div>
